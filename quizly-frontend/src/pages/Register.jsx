    ...
    <div className="min-h-screen pt-24 pb-12 px-4 flex items-center justify-center bg-black mono-grid-bg relative">
      ...
      <div className="auth-container z-10 w-full max-w-md bg-mono-gray-900 border border-mono-gray-600 shadow-2xl p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-mono-gray-400 mt-2 text-sm font-sans">Learn. Practice. Mastery.</p>
        </div>
        ...
        <AnimatePresence mode="wait">
          {step === 1 ? (
            <motion.form
              ...
              className="space-y-5"
            >
              <h2 className="text-2xl font-bold font-display tracking-tight text-white mb-2">Create Account</h2>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-2 bg-transparent text-mono-gray-400 hover:text-white transition-colors text-sm font-semibold"
                >
                  Edit details / Back
                </button>
              </div>
